...
_Generated by `tools/scripts/progress_report.py` on 2026-08-04. Regenerate with `make progress`._
...
48 functions (15804 code bytes) are documented handwritten assembly (`HANDWRITTEN_ASM`, see `docs/ASM_AND_GTE_POLICY.md`) and are excluded from the totals below.

| Binary | Functions | % | Code bytes | % |
|---|---:|---:|---:|---:|
| `SCES_006.50 (main)` | 1105/1105 | 100.0% | 407904/407904 | 100.0% |
