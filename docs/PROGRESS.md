...
47 functions (15712 code bytes) are documented handwritten assembly (`HANDWRITTEN_ASM`, see `docs/ASM_AND_GTE_POLICY.md`) and are excluded from the totals below.

| Binary | Functions | % | Code bytes | % |
|---|---:|---:|---:|---:|
| `SCES_006.50 (main)` | 1057/1106 | 95.6% | 334908/407996 | 82.1% |
