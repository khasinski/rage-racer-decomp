...
49 functions (16076 code bytes) are documented handwritten assembly (`HANDWRITTEN_ASM`, see `docs/ASM_AND_GTE_POLICY.md`) and are excluded from the totals below.

| Binary | Functions | % | Code bytes | % |
|---|---:|---:|---:|---:|
| `SCES_006.50 (main)` | 1101/1104 | 99.7% | 398368/407632 | 97.7% |
