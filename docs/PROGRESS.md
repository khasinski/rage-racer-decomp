...
_Generated by `tools/scripts/progress_report.py` on 2026-07-31. Regenerate with `make progress`._
...
48 functions (15788 code bytes) are documented handwritten assembly (`HANDWRITTEN_ASM`, see `docs/ASM_AND_GTE_POLICY.md`) and are excluded from the totals below.

| Binary | Functions | % | Code bytes | % |
|---|---:|---:|---:|---:|
| `SCES_006.50 (main)` | 1102/1105 | 99.7% | 398656/407920 | 97.7% |
