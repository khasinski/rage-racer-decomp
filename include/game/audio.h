...
void SetSequenceVolume(s32 volume) asm("func_8005E7A0");
void RefreshSequenceVolumeScale(void) asm("func_8005E7DC");
void SetSequenceVolumeScale(s32 scale) asm("func_8005E834");
...
void StopSoundSlotVoice(s32 slot) asm("func_8005B360");
void SetSoundSlotVoiceEnabled(s32 slot, s32 enabled) asm("func_8005B388");
void SetSoundSlotVoicesEnabled(s32 enabled) asm("func_8005B40C");
void SetEffectVoicesEnabled(s32 enabled) asm("func_8005B468");
void ResetSoundState(void) asm("func_8005B488");
...
void SetEffectVolumeScale(s32 scale) asm("func_8005BD2C");
...
void SetEffectVolumeSetting(s32 setting) asm("func_8005BDD4");
...
u32 GetLoadedAudioStep(void) asm("func_8005BE88");
s32 GetActiveAudioSlots(void) asm("func_8005BE98");
...
void SetPanVoiceTargetVolume(s32 left, s32 right) asm("func_8005BEA8");
void ApplyPanVoiceVolume(void) asm("func_8005BF30");
void StartIndexedEffectVoice(s32 baseTone) asm("func_8005C09C");
...
void ForceSoundSlotVoicePlayback(s32 enabled) asm("func_8005E364");
void ForceAllEffectVoicesEnabled(s32 enabled) asm("func_8005E4A4");
...
void StopDirectVoice(s32 voice) asm("func_8005E6F4");
void SetVabSlotVoiceEnabled(s32 voice, s32 enabled, s32 vabSlot) asm("func_8005E718");
void SetDefaultReverbDepth(void) asm("func_8005DBB4");
void InitSequenceAudio(void) asm("func_8005DBD8");
void RestoreReverbDepth(s32 enabled) asm("func_8005DD74");
