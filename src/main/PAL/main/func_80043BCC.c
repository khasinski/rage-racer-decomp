...
block_52:
    ...
    case 2:                                         /* switch 1 */
        ...
        *(WordVector *)&scratch[2] = *(WordVector *)temp_v0_732;
        ...
        temp_s2_794 = temp_s2_728 + D_8019C7CC;
        ...
        *(WordVector *)&scratch[2] = *(WordVector *)arg1;
        if ((temp_v1_40 & 0xFF) || (D_8009B218 != 3)) {
            ...
            if (D_8009B218 == 3) {
                ...
                temp_v0_944 = (temp_v0_30 * 0x24) + D_8019C7CC;
            ...
            temp_a0_976 = (D_8009B248 * 0x24) + D_8019C7CC;
        ...
        } else if (D_8009B244 < FIELD(((D_8009B248 * 0x24) + D_8019C7CC), s32 *, 0x1C)) {
            D_8009B244 += 1;
        }
        temp_a1_1117 = 0x1000 - func_80068634((s32) (D_8009B244 << 0xB) / (s32) FIELD(((D_8009B248 * 0x24) + D_8019C7CC), s32 *, 0x1C));
    ...
    case 4:                                         /* switch 1 */
        ...
        *(WordVector *)&scratch[2] = *(WordVector *)temp_v1_1373;
        ...
        sp18[1] = FIELD((temp_s0_1437 + (u32)D_8019C7CC), s32 *, 0xC);
        sp18[2] = 0x32;
        func_80068F80(&spA8[0], &sp18[0], &sp28[0]);
        temp_s0_1448 = temp_s0_1437 + D_8019C7CC;
