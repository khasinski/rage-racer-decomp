  ...
  else
  {
    ...
    if ((*((s16 *) (((u8 *) temp_s3) + 0x30))) != temp_a0_5)
    {
      ...
      *((u16 *) (((u8 *) temp_s3) + 0x2C)) = temp_a0_6;
      D_8007DA74 = (s32) var_a2;
      if (temp_v0_15 != 0)
      {
        temp_v1_11 = *((s16 *) (((u8 *) temp_s3) + 0x76));
        if (((*((s16 *) (((u8 *) temp_s3) + 0x30))) < temp_v1_11) && (D_8007DA78 < 0))
        {
          if (temp_v1_11 < 4)
          {
            goto block_121;
          ...
          *((u16 *) (((u8 *) temp_s3) + 0x2C)) = (u16) ((temp_a0_6 * temp_v1_12) / 100);
          D_8007DA74 = (temp_v1_12 * ((s32) var_a2)) / 100;
        }
      }
      block_121:
      var_a0_3 = D_8007DA74;
      ...
      D_8007DA74 = var_a0_3;
      {
        u16 targetSpeed = (u16) D_8007DA74;
    ...
    else
    {
      ...
      {
        *((s32 *) (((u8 *) temp_s3) + 0x78)) = (s32) (D_8007DA74 - (((*((s16 *) (((u8 *) temp_s3) + 0x36))) * ((s16) countdown)) / 15));
      }
      else
      {
        temp_a0_7 = (*((s16 *) (((u8 *) temp_s3) + 0x36))) * ((s16) countdown);
        var_v1_4 = temp_a0_7 / 10;
        *((s32 *) (((u8 *) temp_s3) + 0x78)) = D_8007DA74 - var_v1_4;
  ...
  *((s32 *) (((u8 *) temp_s3) + 0x94)) = temp_lo_3;
  ...
  if (g_RacePhase >= 2)
  {
    ...
    switch (temp_v1_22)
    {
      ...
      case 2:
        func_80030814(car, var_a1_7);
        break;

      case 3:
        func_80030BC4(car, var_a1_7);
        break;
