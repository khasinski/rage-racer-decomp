...
void func_8001901C(void) {
    ...
    case 6: {
        ...
        if (func_80017C78(result + 0x58, p) != 0) {
            register u8 *base_a0 asm("$4");
            base_a0 = g_AssetLoadCursor; g_AssetBlockPtr = ASSET_SUB(base_a0, 0); func_80017BD4(g_AssetBlockPtr);
            ...
            base_a0 = g_AssetLoadCursor; g_AssetBlockPtr = ASSET_SUB(base_a0, 5); func_80017A6C(g_AssetBlockPtr);
