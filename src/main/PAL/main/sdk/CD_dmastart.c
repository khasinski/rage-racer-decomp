 ...
 */
void CD_dmastart(s32 ch, u32 madr, u32 count, u32 size, u32 chcrVal, u8 mode) asm("func_8006DB74");
void CD_dmastart(s32 ch, u32 madr, u32 count, u32 size, u32 chcrVal, u8 mode) {
    volatile s32 dummy;
    s32 i;
    volatile u32 *p;
