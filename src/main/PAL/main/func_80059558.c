            ...
            if (t < u ? (u - t <= 0x493DF) : (t - u <= 0x493DF)) {
                if (D_8009B378 < 0) {
                    if (D_801E436E & 0x860) {
                        ...
                        if (D_8019C7C8[D_801E4B88].enabled == 0) {
                            func_8005D6EC(2);
                            D_8009B308 = -1;
                            D_8009B2F8 = 0;
                            D_8009B2F0 = 0;
...
block_51:
        ...
        if (D_8009B308 < 0) {
            if ((u32) (D_8009B308 + 2) < 2U) {
                u16 *pad;

                func_800487D8(D_8019CB00, &D_8009B2F8, 0);
                ...
                if (D_8009B300 <= 0) {
                    ...
                    func_800487D8(&D_80082790, &D_8009B2F8, 0);
                    if (D_8009B2F8 <= 0) {
                        D_8019C7C8[D_801E4B88].enabled = 1;
        ...
        func_80049418(-1, 0, ~D_8019CA18 != 0, ~D_801E41A4 != 0);
        func_8004F650(-1, D_8019C908, value);
        func_800487D8(&D_800820C4, &D_8019C9F0, -1);
