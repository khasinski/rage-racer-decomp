...
/* US build: the cue timers scale for 60 fps like Japan, but the crawl keeps
 * the fourteen English text rows. */
...
void DrawPrologueText(void) {
    ...
    /* The US release keeps PAL's fourteen English text rows. */
    for (i = 0; i < 14; i++) {
        s32 tableY;
