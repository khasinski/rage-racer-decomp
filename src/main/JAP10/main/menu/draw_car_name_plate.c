...
/* Japanese build: the name-plate captions sit on different rows of the
 * texture atlas and two pixels over, matching the Japanese type. */
...
void DrawCarNamePlate(s32 step, s32 model, s32 grade) {
    ...
    case 2:
        ...
        break;
    case 10:
        DrawSprite(ot, 0x100, 0x188, 0x26, 0x10, 0xAA, 0x30, (u8)shade,
                      (u8)shade, (u8)shade, 0x244, 0, 1, 0x3E);
        break;
    case 3:
        ...
        break;
    case 4:
        DrawSprite(ot, 0xFF, 0x188, 0x26, 0x10, 0x76, 0x50, (u8)shade,
                      (u8)shade, (u8)shade, 0x244, 0, 1, 0x3E);
        break;
    case 5:
    ...
    case 6:
        ...
        break;
    case 11:
        DrawSprite(ot, 0x100, 0x188, 0x26, 0x10, 0xE, 0x60, (u8)shade,
                      (u8)shade, (u8)shade, 0x244, 0, 1, 0x3E);
        break;
    case 7:
    ...
    case 9:
        ...
        break;
    case 12:
        DrawSprite(ot, 0xFA, 0x188, 0x2C, 0x10, 8, 0x50, (u8)shade,
                      (u8)shade, (u8)shade, 0x244, 0, 1, 0x3E);
        break;
    }
