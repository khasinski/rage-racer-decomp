...
/* Japanese build: the attract-mode delay is eight seconds at 60 rather
 * than 50 frames, 0x1E0 against PAL's 0x190. */
...
void DrawMainMenuRows(void) {
    ...
    one = 1;
    width = 0x70;
    /* The 1.1 revision nudges this menu row up a line; 1.0 draws it at 0x68. */
    y = 0x68;
